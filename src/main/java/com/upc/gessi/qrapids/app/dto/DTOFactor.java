...
//ToDo There is TWO DTOs for factors: this one and DTOQualityFactor --> This should be reviewed!!!!
public class DTOFactor {
     ...
     */
    public DTOFactor(String id, String name, String description, Float value, LocalDate date, String datasource,
