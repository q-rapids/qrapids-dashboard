...
public class QualityFactorsTest {
    ...
    public void getQualityFactorsEvaluations() throws Exception {
        // Given
        DTODetailedFactorEvaluation dtoQualityFactor = domainObjectsBuilder.buildDTOQualityFactor();
        List<DTODetailedFactorEvaluation> dtoQualityFactorList = new ArrayList<>();
        dtoQualityFactorList.add(dtoQualityFactor);

        String projectExternalId = "test";
        String profileId = "null"; // without profile
        when(qualityFactorsDomainController.getAllFactorsWithMetricsCurrentEvaluation(projectExternalId, profileId, true)).thenReturn(dtoQualityFactorList);
        ...
        // Verify mock interactions
        verify(qualityFactorsDomainController, times(1)).getAllFactorsWithMetricsCurrentEvaluation(projectExternalId,profileId, true);
        verifyNoMoreInteractions(qualityFactorsDomainController);
    }
    ...
    public void getSingleFactorEvaluation() throws Exception {
        // Given
        DTOFactorEvaluation dtoFactor = domainObjectsBuilder.buildDTOFactor();
        String projectExternalId = "test";
    ...
    public void getAllQualityFactors() throws Exception {
        ...
        String projectExternalId = "test";
        when(qualityFactorsDomainController.getAllFactorsEvaluation(projectExternalId, true)).thenReturn(dtoFactorList);
    ...
    public void getQualityFactorsPrediction() throws Exception {
        DTODetailedFactorEvaluation dtoQualityFactor = domainObjectsBuilder.buildDTOQualityFactorForPrediction();
        List<DTODetailedFactorEvaluation> dtoQualityFactorList = new ArrayList<>();
        dtoQualityFactorList.add(dtoQualityFactor);
        String projectExternalId = "test";
        String profileId = "null"; // without profile
    ...
    public void getMetricsEvaluationForQF() throws Exception {
        // Given
        DTOMetricEvaluation dtoMetric = domainObjectsBuilder.buildDTOMetric();
        List<DTOMetricEvaluation> dtoMetricList = new ArrayList<>();
