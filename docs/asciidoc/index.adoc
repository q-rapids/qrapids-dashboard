...
operation::qualityFactors/new[snippets='request-parameters,request-parts,curl-request,http-response']
...
operation::qualityFactors/update[snippets='request-parameters,request-parts,curl-request,http-response']
...
operation::profiles/add[snippets='request-parameters,request-parts,curl-request,http-response']
...
operation::profiles/update[snippets='request-parameters,request-parts,curl-request,http-response']
