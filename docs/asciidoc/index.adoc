...
:numbered!:
==== HTTP response strategic indicators already loaded
include::{snippets}/si/fetch-error/http-response.adoc[]
:numbered:
...
operation::categories/new[snippets='request-fields,curl-request,http-response']


=== Delete categories

operation::categories/delete[snippets='curl-request,http-response']
